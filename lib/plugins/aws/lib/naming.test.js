...
describe('#naming()', () => {
  ...
  describe('#getClusterTopicLogicalId', () => {
    it('should normalize function name, cluster name, and topic name', () => {
      expect(
        sdk.naming.getClusterTopicLogicalId('functionName', 'cluster-name', 'TopicName')
      ).to.equal('FunctionNameEventSourceMappingMSKClusternameTopicName');
    });
  });
});
